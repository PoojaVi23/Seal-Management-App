...
import 'Add_Seal_Data.dart';
import 'Edit_Seals.dart';
import 'package:flutter/services.dart';


class ViewSeal extends StatefulWidget {
  @override
  _ViewSealState createState() => _ViewSealState();
}

class _ViewSealState extends State<ViewSeal> {
  ...
  Future<List<SealData>> _getSealData({String? query}) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$API_URL/Mobile_flutter_api/get_seal_data'),
  ...
  Future<void> deleteSealRecord(String seal_transaction_id) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$API_URL/Mobile_flutter_api/delete_seal_record'),
        headers: {"Accept": "application/json"},
        body: {
          'uuid': _uuid,
          'user_id': _username,
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: MyApplicationBar(
          title: const Text('SEAL MANAGEMENT'),
        ),
...
//                 crossAxisAlignment: CrossAxisAlignment.stretch,
//                 children: [
//                   _buildSealDataRow('Location', seal.location_name?? 'N/A'),
//                   _buildSealDataRow('Transaction ID', seal.seal_transaction_id?? 'N/A'),
//                   _buildSealDataRow('Seal Date', seal.seal_date?? 'N/A'),
//                   _buildSealDataRow('Unloading Date', seal.seal_unloading_date?? 'N/A'),
//                   _buildSealDataRow('Vehicle No', seal.vehicle_no?? 'N/A'),
//                   _buildSealDataRow('Allow Slip No', seal.allow_slip_no?? 'N/A'),
//                   _buildSealDataRow('Plant Name', seal.plant_name?? 'N/A'),
//                   _buildSealDataRow('Material', seal.material_name?? 'N/A'),
//                   _buildSealDataRow('Vessel', seal.vessel_name?? 'N/A'),
//                   _buildSealDataRow('Net Weight', seal.net_weight?? 'N/A'),
//                   _buildSealDataRow('Start Seal No', seal.start_seal_no?? 'N/A'),
//                   _buildSealDataRow('End Seal No', seal.end_seal_no?? 'N/A'),
//                   _buildSealDataRow('Seal Color', seal.seal_color?? 'N/A'),
//                   _buildSealDataRow('No of Seals', seal.no_of_seal?? 'N/A'),
//                   _buildSealDataRow('GPS Seal No', seal.gps_seal_no?? 'N/A'),
//                   _buildSealDataRow('Extra Start Seal No', seal.extra_start_seal_no?? 'N/A'),
//                   _buildSealDataRow('Extra End Seal No', seal.extra_end_seal_no?? 'N/A'),
//                   _buildSealDataRow('No of Extra Seals', seal.extra_no_of_seal.toString()),
//                   _buildSealDataRow('Rejected Seal', seal.rejected_seal_no?? 'N/A'),
//                   _buildSealDataRow('New Seal', seal.new_seal_no?? 'N/A'),
//                   _buildSealDataRow('Sender Remarks', seal.remarks?? 'N/A'),
//                   _buildSealDataRow('Receiver Remarks', seal.rev_remarks?? 'N/A'),
//
//                   // Display a button to view images
//                   ElevatedButton(
//                     onPressed: () {
